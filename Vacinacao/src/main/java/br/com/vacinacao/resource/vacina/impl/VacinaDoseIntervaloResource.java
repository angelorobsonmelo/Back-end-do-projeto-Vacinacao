...
public class VacinaDoseIntervaloResource implements IVacinaDoseIntervaloResource {
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("listarTodasPorSequencialVacina/{sequencialVacina}")
	public ArrayList<VacinaDoseIntervaloVO> listarTodasPorSequencialVacina(@PathParam("sequencialVacina") Integer sequencialVacina) throws BOException, SQLException {
		try {
			...
			return vacinaDoseBO.listarTodasPorSequencialVacina(vacinaDoseVO);
	...
	public ArrayList<VacinaDoseIntervaloVO> listarTodas() throws BOException, SQLException {
		try {
			...
			return vacinaDoseBO.listarTodas();

	...
	app.factory('RotaFactory', ['$q', function ($q, $rootScope) {
		...
		function rota() {
			...
			navigator.geolocation.getCurrentPosition(function (pos) {
				...
				localStorage.setItem('latitude', angular.toJson(pos.coords.latitude));
				localStorage.setItem('longitude', angular.toJson(pos.coords.longitude));
			...
			function calcRoute() {
				...
				var request = {
						...
						destination: new google.maps.LatLng(destino.latitude, destino.longitude),

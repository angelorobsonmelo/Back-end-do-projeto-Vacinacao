...
public class VacinaDoseBO implements IVacinaDoseIntervaloBO {
	...
	public ArrayList<VacinaDoseIntervaloVO> listarTodas(VacinaDoseIntervaloVO vacinaDoseVO) throws BOException, SQLException {
		try {

			/*Setar o AutoCommit para False, validar toda a transação antes do Commit*/
			Conexao.setarAutoCommitParaFalse();

			return vacinaDoseDAO.listarTodas(vacinaDoseVO);
		} catch (Exception e) {

    ...
    app
        .factory('LoginFactory', ['$http', '$q', '$location', '$mdDialog', function ($http, $q, $location, $mdDialog) {
            ...
            function loginConvencional(usuario) {
                ...
                $http.get('http://192.168.0.10:8080/Vacinacao/rest/usuario/login/' + usuario.email + '/' + usuario.senha)
            ...
            function pesquisarPorEmailPosLogin(usuario) {
                ...
                $http.get('http://192.168.0.10:8080/Vacinacao/rest/usuario/pesquisarPorEmailPosLogin/' + usuario.email)

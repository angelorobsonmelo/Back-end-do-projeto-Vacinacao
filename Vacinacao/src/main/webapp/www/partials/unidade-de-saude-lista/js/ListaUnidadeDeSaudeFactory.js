...
(function () {
	...
	app.factory('UnidadeDeSaudeListaFactory', ['$http', '$q', function ($http, $q) {
		...
		function success(position) {
			...
			localStorage.setItem('latitude', angular.toJson(position.coords.latitude));
			localStorage.setItem('longitude', angular.toJson(position.coords.longitude));
		...
		function conectarServidor(){
			...
			$http.get('http://192.168.0.10:8080/Vacinacao/rest/unidadeDeSaude/consultarTodas')
